...
describe("Lua", {concurrency: true}, () => {
    ...
    it("Caesar cipher", async () => {
        const code = `local function encrypt(text, key)
    ...
    do
        ...
        const expectedOutput = "Esp bftnv mczhy qzi ufxapo zgpc esp wlkj ozrd";
