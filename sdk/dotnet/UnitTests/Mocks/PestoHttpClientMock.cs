...
public static class PestoHttpClientMock {
    ...
    public static async Task<string?> CaptureRequestUrlAsync(Func<HttpClient, Task> testAsync) {
        ...
        handlerMock
            ...
            .Callback(
                (HttpRequestMessage requestMessage, CancellationToken _) => {
    ...
    // ReSharper disable once InconsistentNaming
    public static async Task TestHttpClientUsingDummyJsonContentAsync(string jsonContent,
                                                                      Func<HttpClient, Task> testAsync,
    ...
    // ReSharper disable once InconsistentNaming
    public static async Task TestHttpClientUsingDummyJsonResourceAsync(string resourceName,
                                                                       Func<HttpClient, Task> testAsync,
