...
public class PestoClientTests {
    [Fact]
    public Task CanGetPingResponse() => TestPestoApiAsync(
        invokeMethodAsync: (client) => client.PingAsync(CancellationToken.None),
        expectedUrl: "https://pesto.teknologiumum.com/api/ping",
        expectedResponseResourceName: "UnitTests.Responses.SuccessfulPingResponse.json",
    ...
    [Fact]
    public Task CanGetListRuntimes() => TestPestoApiAsync(
        invokeMethodAsync: (client) => client.ListRuntimesAsync(CancellationToken.None),
    ...
    [Fact]
    public Task CanExecuteCode() => TestPestoApiAsync(
        invokeMethodAsync: (client) =>
        ...
        expectedResponseResourceName: "UnitTests.Responses.SuccessfulExecuteCode.json",
        validateResult: response => {
    ...
    [Fact] 
    public Task CanExecuteCode2() => TestPestoApiAsync(
        invokeMethodAsync: client => client.ExecuteAsync("Python", "print('Hello world')", CancellationToken.None),
        expectedUrl: "https://pesto.teknologiumum.com/api/execute",
        expectedResponseResourceName: "UnitTests.Responses.SuccessfulExecuteCode.json",
        validateResult: response => {
            response.Language.Should().Be("Python");
    ...
    public void ShouldThrowExceptionOnFailedPingRequest() {
        Func<Task> f = async () => {
            await TestFailingPestoApiClient(
                ...
                expectedUrl: "https://pesto.teknologiumum.com/api/ping",
                expectedResponseResourceName: "UnitTests.Responses.SuccessfulPingResponse.json",
                validateResult: response => { response.Message.Should().Be("OK"); }
            );
        };
